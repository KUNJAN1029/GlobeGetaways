const destinationData = {
  bali: {
    ...
    badge: "Beach Escape",
    description:
      "A wellness-meets-adventure island retreat with ocean views, temple culture, and slow luxury.",
    longDescription:
      "Bali is ideal for travelers who want their trip to feel both restorative and exciting. Think sunrise walks, beach clubs, waterfalls, local craft villages, and a rhythm that balances relaxation with discovery.",
    price: " ₹70,000",
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and beachside reset",
        text: "Private transfer, check-in, and an easy first evening by the ocean.",
      },
      {
        day: "Day 2",
        title: "Ubud culture trail",
        text: "Rice terraces, artisan studios, and a curated local dining experience.",
      },
      {
        day: "Day 3",
        title: "Waterfall and wellness day",
        text: "A scenic inland route with spa time and relaxed exploration.",
      },
    ],
    inclusions: [
      "Boutique stay",
    ...
    gallery: [
      { src: "./images/bali2.png", alt: "Bali coast and resort view" },
      { src: "images/bali3.png", alt: "Bali travel lifestyle scene" },
      { src: "images/bali4.png", alt: "Bali cinematic travel mood" },
    ],
    faqs: [
      {
        question: "Is Bali better for couples or solo travelers?",
        answer:
          "It works very well for both. Couples usually prefer beach clubs and private villa upgrades, while solo travelers often enjoy wellness-focused stays and social day tours.",
      },
      {
        question: "Can the itinerary include beach time and Ubud together?",
        answer:
          "Yes. That is one of the most common customizations, and we can balance coastal relaxation with inland culture.",
      },
      {
        question: "Do I need a long trip for Bali?",
        answer:
  ...
  patagonia: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and basecamp check-in",
        text: "Settle into your lodge and prepare for the week ahead.",
      },
      {
        day: "Day 2",
        title: "Signature trail experience",
        text: "A guided route through Patagonia's most photogenic scenery.",
      },
      {
        day: "Day 3",
        title: "Glacier and lake circuit",
        text: "A high-impact day focused on nature, pace, and unforgettable views.",
      },
    ],
    inclusions: [
      "Mountain lodge",
    ...
    gallery: [
      {
        src: "images/Patagonia2.png",
        alt: "Patagonia mountains and hiking route",
      },
      {
        src: "images/Patagonia3.png",
        alt: "Patagonia cinematic sky and landscape",
      },
      {
        src: "images/Patagonia4.png",
        alt: "Patagonia travel planning and exploration mood",
      },
    ],
    faqs: [
      {
        question: "How physically demanding is this Patagonia trip?",
        answer:
          "We can shape it from soft adventure to a more active trekking format. The base version is moderate and adjustable.",
      },
      {
        question: "What should I pack?",
        answer:
          "Layers, wind-resistant outerwear, hiking shoes, and a good day bag are the essentials. We can send a full packing list after inquiry.",
      },
      {
        question: "Can this work for first-time adventure travelers?",
        answer:
          "Yes, especially if we prioritize scenic routes and shorter guided hikes over intense trekking days.",
      },
    ],
    query: "patagonia",
  },
  tokyo: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and skyline intro",
        text: "Check-in, neighborhood walk, and first-night city views.",
      },
      {
        day: "Day 2",
        title: "Classic Tokyo contrasts",
        text: "Markets, shrines, shopping streets, and evening dining.",
      },
      {
        day: "Day 3",
        title: "Creative district day",
        text: "Explore art, cafes, and contemporary city culture.",
      },
    ],
    inclusions: [
      "Central hotel",
    ...
    faqs: [
      {
        question: "Is Tokyo difficult to navigate for first-time visitors?",
        answer:
          "Not with the right structure. We include neighborhood guidance, transfer support, and a simple arrival plan.",
      },
      {
        question: "Can I add a day trip from Tokyo?",
        answer:
          "Yes. Popular add-ons include Hakone, Nikko, and Fuji-area scenic escapes.",
      },
      {
        question: "Does this trip work for food-focused travelers?",
        answer:
          "Very well. We can shape the route around markets, local dining, and chef-led experiences.",
      },
    ],
    query: "tokyo",
  },
  serengeti: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and camp welcome",
        text: "Transfer into the reserve and settle into your safari camp.",
      },
      {
        day: "Day 2",
        title: "Morning and evening drives",
        text: "Track wildlife through prime viewing hours with expert guides.",
      },
      {
        day: "Day 3",
        title: "Bush breakfast and open plains",
        text: "A signature day designed around timing, light, and movement.",
      },
    ],
    inclusions: [
      "Safari camp",
    ...
    faqs: [
      {
        ...
        answer:
          "The dry season is strongest overall, but timing can be adjusted based on migration interest and your preferred pace.",
      },
      {
        question: "Is this itinerary family-friendly?",
        answer:
          "Yes, for older children especially. We can adapt lodge choices and drive times to suit family travel.",
      },
      {
        question: "What level of comfort should I expect?",
        answer:
          "The default version is premium and comfortable, with excellent guides, well-run camps, and thoughtful service.",
      },
    ],
    query: "serengeti",
  },
  barcelona: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Arrival and Gothic Quarter stroll",
        text: "Ease into the city with a walk through historic streets.",
      },
      {
        day: "Day 2",
        title: "Gaudi and city culture",
        text: "A day focused on architecture, art, and rooftop views.",
      },
      {
        day: "Day 3",
        title: "Mediterranean leisure day",
        text: "Markets, beach time, and a slow evening dining plan.",
      },
    ],
    inclusions: [
      "Boutique hotel",
    ...
    faqs: [
      {
        question: "Can I mix sightseeing with a slower beach day?",
        answer:
          "Yes. Barcelona is perfect for balancing architecture, food, and lighter Mediterranean downtime.",
      },
      {
        question: "Is this a good short European break?",
        answer:
          "Absolutely. It works especially well for 4 to 5 nights with a focused city plan.",
      },
      {
        question: "Can football or event tickets be added?",
        answer:
          "Yes, subject to schedule and availability. We can include major local experiences as add-ons.",
      },
    ],
    query: "barcelona",
  },
  maldives: {
    ...
    itinerary: [
      {
        day: "Day 1",
        title: "Seaplane arrival and villa check-in",
        text: "Begin with a scenic transfer and a relaxed resort welcome.",
      },
      {
        day: "Day 2",
        title: "Ocean and wellness day",
        text: "Choose between snorkeling, spa time, or simply slowing down.",
      },
      {
        day: "Day 3",
        title: "Signature sunset experience",
        text: "A curated day ending with a premium private dining moment.",
      },
    ],
    inclusions: [
      "Resort stay",
    ...
    faqs: [
      {
        question: "Is the Maldives only for honeymoon trips?",
        answer:
          "No. It is also great for birthdays, anniversary trips, and travelers who simply want a quiet luxury reset.",
      },
      {
        question: "Can I choose between beach villa and overwater villa?",
        answer:
          "Yes. We can price both options and suggest the best fit for your budget and travel style.",
      },
      {
        question: "Are activities included?",
        answer:
          "Core inclusions vary by resort, but we can package dining, transfers, snorkeling, and wellness add-ons.",
      },
    ],
    query: "maldives",
  },
    ...
    (entries) => {
      entries.forEach((entry) => {
        if (
          ...
          animateCounter(
            entry.target,
            Number.parseInt(entry.target.dataset.target, 10),
          );
        }
      });
    },
...
function setupBookingForm() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (!form.checkValidity() || !slug) {
      ...
      if (feedback) {
        feedback.textContent = slug
          ? "Please complete all booking fields."
          : "Choose one of the listed destinations so we can match the right trip.";
...
function renderDestinationPage() {
  ...
  document.getElementById("detailLongDescription").textContent =
  ...
  highlights.innerHTML = destination.highlights
    .map((item) => `<span><i class="fa-solid fa-check"></i>${item}</span>`)
    .join("");

  const facts = document.getElementById("detailFacts");
  facts.innerHTML = destination.facts
    .map(
      (fact) => `
        <div class="fact-card">
  ...
  itinerary.innerHTML = destination.itinerary
    .map(
      (item) => `
  ...
  inclusions.innerHTML = destination.inclusions
    .map((item) => `<li><i class="fa-solid fa-check"></i>${item}</li>`)
    .join("");

  const travelerTags = document.getElementById("travelerTags");
  travelerTags.innerHTML = destination.travelers
    .map((item) => `<span>${item}</span>`)
    .join("");

  const faqList = document.getElementById("faqList");
  if (faqList) {
    faqList.innerHTML = destination.faqs
      .map(
        (item, index) => `
    ...
    if (!form.checkValidity()) {
      ...
      if (feedback) {
        feedback.textContent =
          "Please fill in your contact details so we can send the custom quote.";
        feedback.classList.add("is-visible");
      }
      return;
    }
